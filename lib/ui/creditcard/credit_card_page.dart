...
import 'widgets/card_alert_dialog.dart';
import 'widgets/card_date_input_formatter.dart';
import 'widgets/card_input_formtter.dart';
...
class _CreditCardPageState extends State<CreditCardPage> {
 ...
 final FlipCardController flipCardController = FlipCardController();
   ...
   Widget build(BuildContext context) {
       return Scaffold(
           appBar: AppBar(
              title: const Text('Cadastro de Cartões', style: TextStyle(color: Colors.white),),
              ...
              FlipCard(
                  ...
                  front: Padding(
                    ...
                    child: buildCreditCard(
                      color: ColorsApp.instance.dartblue,
